...
#define INVENTORY_OUT_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/printed_inventory.txt"
#define INVENTORY_TEST_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/expected_inventory.txt"
#define ORDER_OUT_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/printed_order.txt"
#define ORDER_TEST_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/expected_order.txt"
#define BEST_SELLING_OUT_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/printed_best_selling.txt"
#define BEST_SELLING_TEST_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/expected_best_selling.txt"
#define NO_SELLING_OUT_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/printed_no_selling.txt"
#define NO_SELLING_TEST_FILE "/tmp/tmp.kK1yelDbNa/cmake-build-debug/expected_no_selling.txt"
